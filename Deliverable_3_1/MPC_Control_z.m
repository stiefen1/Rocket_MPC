classdef MPC_Control_z < MPC_Control
    ...
    methods
        ...
        function ctrl_opti = setup_controller(mpc, Ts, H)
            ...
            [~,~] = Terminal_Invariant(H,h,G,g,mpc.A,mpc.B,-K,'z');
            ...
            for i=1:N-1
                ...
                % constant is trim point, always same value for whole project
                con = con + [50 <= u{i}+56.6666665401736 <= 80];
